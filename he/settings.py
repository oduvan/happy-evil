...
DATABASES = {
    'default': {
        ...
        'NAME': 'he',                      # Or path to database file if using sqlite3.
        'USER': 'oduvan',                      # Not used with sqlite3.
...
SECRET_KEY = '38zcku#^$c+a^ath2jtzexx(9yn5q#m(fi5%t499-$v5s9$@46'
